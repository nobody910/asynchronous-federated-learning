...
save_path = 'results_mnist_save/ALU+TWF+IWE-IE_thre_1106_result1.xlsx'
...
save_path_flag = 'results_mnist_save/ALU+TWF+IWE-IE_thre_1106_flag_1.xlsx'
#####################################################################
...
for r in range(0,rounds):
    ...
    #weights = np.array(model.get_weights())
        ...
        threshold = 1/(1+np.exp(-(-0.624918*t_p-2.62646*delta_acc+2.61522))) 
...
plot_result(global_model_test_acc,'ALU+TWF+IWE-IE','accuracy')
